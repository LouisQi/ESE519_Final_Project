...
Reference:
  + Reference from: https://davidegironi.blogspot.com/2019/04/hx711-load-cell-amplifier-driver-for.html
...
//set ports and pins
#define HX711_DTPORT			PORTD
#define HX711_DTDDR				DDRD
#define HX711_DTPIN				PIND
#define HX711_DTPINNUM			PORTD6
#define HX711_SCKPORT			PORTD
#define HX711_SCKDDR			DDRD
#define HX711_SCKPINNUM			PORTD5
